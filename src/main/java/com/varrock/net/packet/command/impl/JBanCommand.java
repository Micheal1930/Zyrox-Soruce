 ...
 **/
@CommandHeader(command = { "jban"}, description = "J bans a player.")
public class JBanCommand extends Command {
    ...
    public boolean execute(Player player, String[] args) throws Exception {
        ...
        GameServer.punishmentManager.startPunishment(player, name, other.getjSerial(), PunishmentType.J_BANNED);
