...
public class NPCUpdating {
	...
	public static void update(Player player) {
		if (player.hasAttribute("skip_update_tick")) {
			player.removeAttribute("skip_update_tick");
			return;
		}
	...
	public static void resetFlags(NPC npc) {
		...
		if (npc.getUpdateFlag().flagged(Flag.ANIMATION) && npc.getUpdateFlag().flagged(Flag.TRANSFORM)) {
			transformAnim = true;
			//System.out.println("Reanimating " + npc.getAnimation());
		}
