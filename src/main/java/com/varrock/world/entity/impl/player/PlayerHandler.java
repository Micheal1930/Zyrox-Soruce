...
import com.varrock.engine.task.impl.*;
...
import com.varrock.model.log.impl.ConnectionLog;
import com.varrock.model.log.impl.SuspiciousLoginLog;
...
import com.varrock.world.content.StaffList;
...
import com.varrock.world.content.combat.effect.CombatPoisonEffect;
import com.varrock.world.content.combat.effect.CombatTeleblockEffect;
import com.varrock.world.content.combat.effect.CombatVenomEffect;
...
import com.varrock.world.content.hiscores.Hiscores;
...
public class PlayerHandler {
    ...
    public static void handleLogin(Player player) {
     ...
     //   player.getDailyLogin().LoggedIn();
        ...
        player.getPacketSender().sendMessage("<col=0000ff><img=475> Welcome to Varrock<col=000000> - There is currently <col=0000ff> " + World.getPlayersOnline() + " playes online.");
