...
public class DiggingScrolls {
	...
	public static enum DigData {
		...
		DIG1(new String[] { "Dig near some giant mushrooms ",
				" behind The Grand Tree" }, 3618, new Position(2458, 3504), 1),
		DIG2(
	...
	public static boolean digClue(Player player) {
		...
		case 1:
			player.getInventory().add(new Item(ClueScroll.CASKET_LV1, 1), "Dig for clue scroll");
			break;
		case 2:
			player.getInventory().add(new Item(ClueScroll.CASKET_LV2, 1), "Dig for clue scroll");
			break;
		case 3:
			player.getInventory().add(new Item(ClueScroll.CASKET_LV3, 1), "Dig for clue scroll");
			break;
		}
