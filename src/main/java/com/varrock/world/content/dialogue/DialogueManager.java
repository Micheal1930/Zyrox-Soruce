...
public class DialogueManager {
	...
	public static void start(Player player, Dialogue dialogue) {
		...
		if(dialogue.closeInterface()) {
			if (player.isBanking() || player.getInterfaceId() > 0 && player.getInterfaceId() != 50)
	...
	public static void next(Player player) {
		...
		if(next == null) {
			if(player.getTutorialStage() != TutorialStages.COMPLETED) {
				next = player.getTutorialStage().getDialogue();
			}
		}
