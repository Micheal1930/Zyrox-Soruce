...
import com.varrock.engine.task.impl.HunterTrapsTask;
...
import com.varrock.world.content.skill.impl.hunter.Trap.TrapState;
...
public class Hunter {
	...
	private static final double[] exps = { 34, 47, 61, 64.4, 95, 0, 198.25, 265 };
	...
	public static void dismantle(Player client, GameObject trap) {
		...
		if (theTrap != null && theTrap.getOwner() == client) {
			...
			if (theTrap instanceof SnareTrap)
				client.getInventory().add(10006, 1, "Hunter dismantle trap");
			else if (theTrap instanceof BoxTrap) {
				client.getInventory().add(10008, 1, "Hunter dismantle trap");
			...
			if(theTrap != null) {
				if (theTrap.getOwner() != null)
					if (theTrap.getOwner() == client) {
						if (theTrap instanceof SnareTrap) {
							client.getInventory().add(10006, 1, "Hunter loot trap");
							client.getInventory().add(526, 1, "Hunter loot trap");
							if (theTrap.getGameObject().getId() == 19180) {
								client.getInventory().add(10088,  20 + Misc.getRandom(30), "Hunter loot trap");
								client.getInventory().add(9978, 1, "Hunter loot trap");
								client.getPacketSender()
								.sendMessage("You've succesfully caught a crimson swift.");
								client.getSkillManager().addExperience(Skill.HUNTER, exps[0] * Skill.HUNTER.getModifier() );
							} else if (theTrap.getGameObject().getId() == 19184) {
								client.getInventory().add(10090,20 + Misc.getRandom(30), "Hunter loot trap");
								client.getInventory().add(9978, 1, "Hunter loot trap");
								client.getPacketSender()
								.sendMessage(
										"You've succesfully caught a Golden Warbler.");
								client.getSkillManager().addExperience(Skill.HUNTER, exps[1] * Skill.HUNTER.getModifier());
							} else if (theTrap.getGameObject().getId() == 19186) {
								client.getInventory().add(10091,
										20 + Misc.getRandom(50), "Hunter loot trap");
								client.getInventory().add(9978, 1, "Hunter loot trap");
								client.getPacketSender()
								.sendMessage(
										"You've succesfully caught a Copper Longtail.");
								client.getSkillManager().addExperience(Skill.HUNTER, exps[2] * Skill.HUNTER.getModifier());
							} else if (theTrap.getGameObject().getId() == 19182) {
								client.getInventory().add(10089,
										20 + Misc.getRandom(30), "Hunter loot trap");
								client.getInventory().add(9978, 1, "Hunter loot trap");
								client.getPacketSender()
								.sendMessage(
										"You've succesfully caught a Cerulean Twitch.");
								client.getSkillManager().addExperience(Skill.HUNTER, (exps[3] * Skill.HUNTER.getModifier()));
								...
								client.getSkillManager().addExperience(Skill.HUNTER, exps[4] * Skill.HUNTER.getModifier());
							}
						} else if (theTrap instanceof BoxTrap) {
							client.getInventory().add(10008, 1, "Hunter loot trap");
							if (theTrap.getGameObject().getId() == 19191) {
								client.getInventory().add(10033, 1, "Hunter loot trap");
								client.getSkillManager().addExperience(Skill.HUNTER, exps[6] * Skill.HUNTER.getModifier());
								client.getPacketSender().sendMessage(
										"You've succesfully caught a chinchompa!");
							} else if (theTrap.getGameObject().getId() == 19189) {
								client.getInventory().add(10034, 1, "Hunter loot trap");
								client.getSkillManager().addExperience(Skill.HUNTER, exps[7] * Skill.HUNTER.getModifier());
								client.getPacketSender()
								.sendMessage(
			...
			for(Trap trap : traps) {
				if(trap != null) {
					if(trap.getOwner() != null && trap.getOwner().getUsername().equals(p.getUsername())) {
						deregister(trap);
						if (trap instanceof SnareTrap)
							p.getInventory().add(10006, 1, "Hunter logout");
						else if (trap instanceof BoxTrap) {
							p.getInventory().add(10008, 1, "Hunter logout");
