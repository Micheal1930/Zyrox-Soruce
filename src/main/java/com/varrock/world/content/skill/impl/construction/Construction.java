package com.varrock.world.content.skill.impl.construction;
...
import com.varrock.world.content.skill.impl.construction.ConstructionData.Butlers;
import com.varrock.world.content.skill.impl.construction.ConstructionData.Furniture;
import com.varrock.world.content.skill.impl.construction.ConstructionData.HotSpots;
import com.varrock.world.content.skill.impl.construction.ConstructionData.HouseLocation;
import com.varrock.world.content.skill.impl.construction.ConstructionData.HouseTheme;
import com.varrock.world.content.skill.impl.construction.ConstructionData.Portals;
import com.varrock.world.content.skill.impl.construction.ConstructionData.RoomData;
import com.varrock.world.content.skill.impl.construction.Palette.PaletteTile;
...
public class Construction {
	...
	public static void placeNPCs(Player p) {
		...
		if (p.getHouseServant() > 0) {
			...
			Servant npc = (Servant) NPC.of(p.getHouseServant(), new Position(toX + 3, toY + 1, p.getPosition().getZ()));
		...
		for (HouseFurniture pf : p.getHouseFurniture()) {
			...
			Servant npc = (Servant) NPC.of(npcId, new Position(actualX, actualY));
	...
	public static boolean buildActions(Player p, Furniture f, HotSpots hs) {
		...
		p.getSkillManager().addExperience(Skill.CONSTRUCTION, f.getXP() * 18);
		return true;
	}
	...
	public static boolean handleButtonClick(int buttonId, Player p) {
		...
		case 2471:
			if (p.getDialogueActionId() == 423) {
				p.getInventory().add(7688, 1, "Construction");
			}
			if (p.getDialogueActionId() == 428) {
				p.getInventory().add(1923, 1, "Construction");
				return true;
			}
		...
		case 2472:
			if (p.getDialogueActionId() == 423) {
				p.getInventory().add(7702, 1, "Construction");
				return true;
			}
			if (p.getDialogueActionId() == 428) {
				p.getInventory().add(1887, 1, "Construction");
				return true;
			}
			if (p.getDialogueActionId() == 442) {
				p.getPacketSender().sendInterfaceRemoval();
		...
		case 2473:
			if (p.getDialogueActionId() == 423) {
				p.getInventory().add(7728, 1, "Construction");
				return true;
			}
			if (p.getDialogueActionId() == 428) {
		...
		case 2482:
			...
			if (p.getDialogueActionId() == 434) {
				p.getInventory().add(7738, 1, "Construction");
				return true;
			}
			if (p.getDialogueActionId() == 440) {
				p.getInventory().add(7671, 1, "Construction");
				return true;
			}
		...
		case 2483:
			...
			if (p.getDialogueActionId() == 430) {
				p.getInventory().add(2313, 1, "Construction");
				return true;
			}
			if (p.getDialogueActionId() == 434) {
				p.getInventory().add(1927, 1, "Construction");
				return true;
			}
			if (p.getDialogueActionId() == 440) {
				p.getInventory().add(7673, 1, "Construction");
				return true;
			}
			if (p.getDialogueActionId() == 644) {
				p.getRegionInstance().remove(p);
		...
		case 2484:
			...
			if (p.getDialogueActionId() == 430) {
				p.getInventory().add(1931, 1, "Construction");
				return true;
			}
			if (p.getDialogueActionId() == 434) {
				p.getInventory().add(1944, 1, "Construction");
				return true;
			}
			if (p.getDialogueActionId() == 440) {
				p.getInventory().add(7675, 1, "Construction");
				return true;
			}
			if (p.getDialogueActionId() == 644) {
				p.getRegionInstance().remove(p);
		...
		case 2485:
			if (p.getDialogueActionId() == 424) {
				p.getInventory().add(1919, 1, "Construction");
				return true;
			}
			if (p.getDialogueActionId() == 430) {
			...
			if (p.getDialogueActionId() == 434) {
				p.getInventory().add(1933, 1, "Construction");
				return true;
			}
			if (p.getDialogueActionId() == 440) {
				p.getInventory().add(7676, 1, "Construction");
				return true;
			}
			if (p.getDialogueActionId() == 644) {
				p.getRegionInstance().remove(p);
		...
		case 2494:
			...
			if (p.getDialogueActionId() == 436) {
				p.getInventory().add(1942, 1, "Construction");
				return true;
			}
			break;
		case 2495:
			...
			if (p.getDialogueActionId() == 436) {
				p.getInventory().add(1550, 1, "Construction");
				return true;
			}
			break;
		case 2496:
			...
			if (p.getDialogueActionId() == 425 || p.getDialogueActionId() == 426 || p.getDialogueActionId() == 427 || p.getDialogueActionId() == 429 || p.getDialogueActionId() == 431) {
				p.getInventory().add(7732, 1, "Construction");
				return true;
			}
			if (p.getDialogueActionId() == 432) {
				p.getInventory().add(1931, 1, "Construction");
			...
			if (p.getDialogueActionId() == 436) {
				p.getInventory().add(1957, 1, "Construction");
				return true;
			}
			break;
		case 2497:
			...
			if (p.getDialogueActionId() == 432) {
				p.getInventory().add(1949, 1, "Construction");
				return true;
			}
			if (p.getDialogueActionId() == 435) {
				p.getInventory().add(1933, 1, "Construction");
			...
			if (p.getDialogueActionId() == 436) {
				p.getInventory().add(1985, 1, "Construction");
				return true;
			}
			break;
		case 2498:
			...
			if (p.getDialogueActionId() == 441) {
				p.getInventory().add(7679, 1, "Construction");
				return true;
			}
			if (p.getDialogueActionId() == 425) {
				p.getInventory().add(1887, 1, "Construction");
	...
	public static boolean handleSpaceClick(int obX, int obY, int objectId, Player p) {
		...
		if(p == null || p.getRegionInstance() == null || p.getRegionInstance().getOwner() == null || p.getRegionInstance().getOwner().getHouseRooms() == null) {
			return false;
		}
		...
		try {
			roomRot = p.getRegionInstance().getOwner().getHouseRooms()[p.inConstructionDungeon() ? 4 : p.getPosition().getZ()][myTiles[0] - 1][myTiles[1] - 1].getRotation();
		} catch(Throwable t) {
			return false;
		}
