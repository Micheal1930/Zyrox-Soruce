package com.varrock.world.content.skill.impl.thieving;
...
public enum PickPocketableNPC {
	MAN(new short[] { 1, 2, 3, 4, 5, 6, 16, 24, 170 }, new byte[] { 1, 11, 21, 31 }, new byte[] { 1, 1, 11, 21 }, 8.0,
			4, 10, 257211, new Item(995, 3)),
	DESERT_PHONIX(new short[] { 1911 }, new byte[] { 1, 127, 127, 127 }, new byte[] { 1, 1, 1, 1 }, 26, 4, 15, 257211,
			new Item(4621, 1)),
	FARMER(new short[] { 7, 1757, 1758, 1760 }, new byte[] { 10, 20, 30, 40 }, new byte[] { 1, 10, 20, 30 }, 14.5, 4,
			10, 257211, new Item(995, 9), new Item(5318, 1)),
	FEMALE_HAM(new short[] { 1715 }, new byte[] { 15, 25, 35, 45 }, new byte[] { 1, 15, 25, 35 }, 18.5, 3, 10, 257211,
	...
	MALE_HAM(new short[] { 1714, 1716 }, new byte[] { 20, 30, 40, 50 }, new byte[] { 1, 20, 30, 40 }, 22.5, 3, 20,
			257211, new Item(995, 12), new Item(590), new Item(1621), new Item(1623), new Item(1625), new Item(1269),
			new Item(321), new Item(2138), new Item(4298), new Item(4300), new Item(4302), new Item(4304),
			new Item(4306), new Item(4308), new Item(4310), new Item(1267), new Item(1353), new Item(199),
			new Item(201), new Item(203), new Item(205), new Item(686), new Item(697), new Item(453), new Item(688),
			new Item(314, 3)),
	HAM_GUARD(new short[] { 1710, 1711, 1712 }, new byte[] { 20, 30, 40, 50 }, new byte[] { 1, 20, 30, 40 }, 22.5, 3,
			30, 257211, new Item(995, 12), new Item(590), new Item(1621), new Item(1623), new Item(1625),
	...
	WARRIOR(new short[] { 15, 18 }, new byte[] { 25, 35, 45, 55 }, new byte[] { 1, 25, 35, 45 }, 26, 5, 20, 257211,
			new Item(995, 18)),
	ROGUE(new short[] { 187, 2267, 2268, 2269, 8122 }, new byte[] { 32, 42, 52, 62 }, new byte[] { 1, 32, 42, 52 },
			35.5, 4, 20, 257211, new Item(995, 25), new Item(995, 40), new Item(1993), new Item(556, 2), new Item(1219),
			new Item(1523), new Item(1944)),
	CAVE_GOBLIN(
			new short[] { 5752, 5753, 5754, 5755, 5756, 5757, 5758, 5759, 5760, 5761, 5762, 5763, 5764, 5765, 5766,
					5767, 5768 },
			new byte[] { 36, 46, 56, 66 }, new byte[] { 1, 36, 46, 56 }, 40, 4, 10, 257211, new Item(995, 30),
			new Item(590), new Item(4522), new Item(4544), new Item(596), new Item(1939), new Item(441, 4),
			new Item(441), new Item(10981)),
	MASTER_FARMER(new short[] { 2234, 2235 }, new byte[] { 38, 48, 58, 68 }, new byte[] { 1, 38, 48, 58 }, 43, 4, 30,
			257211, new Item(5096), new Item(5097), new Item(5098), new Item(5099), new Item(5100), new Item(5101),
	...
	GNOME(new short[] { 66, 67, 68, 168, 169, 2249, 2250, 2251, 2371, 2649, 2650, 6002, 6004 },
			new byte[] { 75, 85, 95, 105 }, new byte[] { 1, 75, 85, 95 }, 198.5, 4, 10, 108718, new Item(995, 300),
			new Item(557), new Item(444), new Item(569), new Item(2150), new Item(2162)),
	HERO(new short[] { 21 }, new byte[] { 80, 90, 100, 110 }, new byte[] { 1, 80, 90, 100 }, 275, 5, 40, 99175,
	...
	DWARF_TRADER(
			new short[] { 2109, 2110, 2111, 2112, 2113, 2114, 2115, 2116, 2117, 2118, 2119, 2120, 2121, 2122, 2123,
					2124, 2125, 2126 },
			new byte[] { 90, 100, 110, 120 }, new byte[] { 1, 90, 100, 110 }, 556.5, 6, 10, 99175, new Item(995, 100),
	 ...
	 * 
	 * @param id The npc id.
	 * @return The {@code PickpocketableNPC} {@code Object}, or {@code null} if the
	 *         data was non-existant.
	 */
	...
	/**
	 * The thieving levels required (slot 0 = normal loot, 1 = double, 2 = 3x loot,
	 * 4 = 4x loot).
	 */
	 ...
	 * 
	 * @param npcIds        The array containing all the npc ids of the npcs using
	 *                      this pickpocket data.
	...
	private PickPocketableNPC(short[] npcIds, byte[] thievingLevel, byte[] agilityLevel, double experience,
			int stunTime, int stunDamage, int petChance, Item... loot) {
		this.npcIds = npcIds;
