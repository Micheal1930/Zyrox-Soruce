package com.varrock.world.content.minigames;
...
public class MinigameAttributes {
	...
	public class BarrowsMinigameAttributes {
		...
		public void setBarrowsState(int index, int state) {
			this.barrowsData[index][1] = state;
		}
	}
	...
	public class GodwarsDungeonAttributes {
		...
		public void setKillcount(int index, int value) {
			killcount[index] = value;
		}
	...
	public class DungeoneeringAttributes {
		...
		public void setBoundItem(int index, int value) {
			boundItems[index] = value;
		}
