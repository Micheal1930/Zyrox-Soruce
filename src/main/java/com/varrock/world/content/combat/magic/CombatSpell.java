...
public abstract class CombatSpell extends Spell {
	...
	/**
	 * The maximum hit an {@link GameCharacter} can deal with this spell.
	 * 
	 ...
	 */
	public abstract Optional<Projectile> castProjectile(GameCharacter cast,
	 ...
	 */
	public abstract void finishCast(GameCharacter cast, GameCharacter castOn,
