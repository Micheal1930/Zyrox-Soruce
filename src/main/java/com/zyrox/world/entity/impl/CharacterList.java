 ...
 */
public final class CharacterList<E extends GameCharacter> implements Iterable<E> {
	...
	public CharacterList(int capacity) {
		...
		this.characters = (E[]) new GameCharacter[capacity];
		this.size = 0;
	}
	 ...
	 * @param action
	 */
	public void shuffledEach(Consumer<? super E> action) {
	...
	public void clear() {
		forEach(this::remove);
		characters = (E[]) new GameCharacter[capacity];
		size = 0;
	}
	 ...
	 * @author lare96 <http://github.com/lare96>
	 */
	private static final class CharacterListIterator<E extends GameCharacter> implements Iterator<E> {
