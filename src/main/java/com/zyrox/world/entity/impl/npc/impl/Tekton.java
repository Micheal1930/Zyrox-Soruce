...
import com.zyrox.world.content.combat.CombatBuilder.CombatDamageCache;
import com.zyrox.world.entity.impl.GroundItemManager;
import com.zyrox.world.entity.impl.npc.NPC;
import com.zyrox.world.entity.impl.player.Player;

/**
 * A class that handles the Tekton boss.
 * 
 * @author Blake
 *
 */
public class Tekton extends NPC {
	 ...
	 * The npc id.
	 */
	public static final int NPC_ID = 22542;

	/**
	 * Constructs a new {@link Tekton}.
	 * 
	 * @param position
	 *            The position.
	 */
	public Tekton(Position position) {
	...
	/**
	 * Handles the drops for the Tekton.
	 * 
	 * @param npc
	 *            The npc.
	 */
	...
	public static void giveLoot(Player player, NPC npc, Position pos) {
		...
		World.sendMessage("<img=469> <col=dbffba><shad=1>"+player.getUsername()+ " received a loot from the @gre@Mighty Tekton!");
