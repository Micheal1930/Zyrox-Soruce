...
public class TriviaBot {
	...
	public static final String[][] TRIVIA_DATA = {
			...
			{ "<img=462><col=0037B1> [Trivia]:</col> What is the name of the server?", "Zyrox" },
			...
			{ "<img=462><col=0037B1> [Trivia]:</col> What is the maximum combat level in Zyrox?", "138" },
			{ "<img=462><col=0037B1> [Trivia]:</col> What defence level is required to wear barrows?", "70" },
			{ "<img=462><col=0037B1> [Trivia]:</col> Where can you get void armour in Zyrox?", "pest control" },
			...
			{ "<img=462><col=0037B1> [Trivia]:</col> Who is the owner of Zyrox?", "Hobos" },
			{ "<img=462><col=0037B1> [Trivia]:</col> Who is the developer of Zyrox?", "Hobos" },
			...
			{ "<img=462><col=0037B1> [Trivia]:</col> How many skills are there in Zyrox", "25" },
			{ "<img=462><col=0037B1> [Trivia]:</col> What is the best offensive range prayer in the normal prayer book?", "rigour" },
			{ "<img=462><col=0037B1> [Trivia]:</col> What is your total level if you have 99 in every skill in Zyrox?", "2475" },
			...
			{ "<img=462><col=0037B1> [Trivia]:</col> What food heals the most in Zyrox", "rocktail" },
			...
			{ "<img=462><col=0037B1> [Trivia]:</col> In what month was Zyrox released?", "May 20th" },
			...
			{ "<img=462><col=0037B1> [Trivia]:</col> How many Crates are there in the Zyrox general store?", "10" },
