...
public enum TutorialStages {
    ...
    SHOPS(new Position(3080, 3509), "These are the shops where you can", "buy items. You can also sell items to", "the general store to get coins!"),
    AUCTION_HOUSE(new Position(3106, 3498), "This is the auction house where you", "can buy, or sell items with other players.", "It's basically player owned shops on crack!"),
    ...
    SKILLING(new Position(3087, 3471), "This is the home skilling area.", "You can skill with players that", "are doing other types of skills!"),
    ...
    ALTAR_ROOM(new Position(3095, 3510), "Switch your spell/prayer books here.", "Don't be a noob, taste vengeance!"),
    THIEVING(new Position(3094, 3486), "Steal items from these stalls, and sell", "the items to the merchant for quick cash.", "Be careful, don't get caught or he will call the cops."),
