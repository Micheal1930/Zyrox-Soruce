...
public class RunecraftingData {
	...
	public enum RuneData {
		  ...
		  MIND_RUNE(558, 2, 5.5, 2479, false),
		  WATER_RUNE(555, 5, 6, 2480, false),
		  EARTH_RUNE(557, 9, 6.5, 2481, false),
		  FIRE_RUNE(554, 14, 7, 2482, false),
		  BODY_RUNE(559, 20, 7.5, 2483, false),
		  COSMIC_RUNE(564, 27, 8, 2484, true),
		  CHAOS_RUNE(562, 35, 8.5, 2487, true),
		  ASTRAL_RUNE(9075, 40, 8.7, 17010, true),
		  NATURE_RUNE(561, 44, 9, 2486, true),
		  LAW_RUNE(563, 54, 9.5, 2485, true),
		  DEATH_RUNE(560, 65, 10, 2488, true),
		  BLOOD_RUNE(565, 75, 23.8, 30624, true),
		  ARMADYL_RUNE(21083, 77, 28, 47120, true);
		
		RuneData(int rune, int levelReq, double xpReward, int altarObjectID, boolean pureRequired) {
			this.runeID = rune;
			this.levelReq = levelReq;
