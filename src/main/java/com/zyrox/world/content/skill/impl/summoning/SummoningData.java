...
import com.zyrox.world.content.skill.impl.summoning.BossPets.BossPet;
...
public class SummoningData {
    ...
    public static boolean isPouch(int item) {
            FamiliarData familiar = FamiliarData.forId(item);
            BossPet pet = BossPet.forId(item);
            return familiar != null || pet != null;
    }
	...
	public static enum FamiliarCombatData {
		...
		public static FamiliarCombatData getDefinition(int id) {
