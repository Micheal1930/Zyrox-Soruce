...
public final class WeaponInterfaces {
	...
	public enum WeaponInterface {
		...
		DINH(75321, 428, 6, new FightType[]{FightType.WARHAMMER_POUND,
				FightType.WARHAMMER_PUMMEL, FightType.WARHAMMER_BLOCK}, 7474, 7486),
		...
		VINE(12290, 12293, 4, new FightType[]{FightType.WHIP_FLICK,
				FightType.WHIP_LASH, FightType.WHIP_DEFLECT}, 12323, 12335),
		THROWNAXE(4446, 4449, 5, new FightType[]{
		...
		BLOWPIPE(1764, 1767, 3, new FightType[] { FightType.BLOWPIPE_ACCURATE, FightType.BLOWPIPE_RAPID,
				FightType.BLOWPIPE_LONGRANGE }, 7549, 7561),

		MORRIGANS(4446, 4449, 6, new FightType[]{FightType.JAVELIN_ACCURATE,
				FightType.JAVELIN_RAPID, FightType.JAVELIN_LONGRANGE}, 7649, 7661);
	...
	public static void assign(Player player) {
		assign(player, player.getEquipment().get(Equipment.WEAPON_SLOT));
	}
}
