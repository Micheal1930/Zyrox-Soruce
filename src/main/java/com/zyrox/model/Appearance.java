...
public class Appearance {
	 ...
	 */
	public Appearance setGender(Gender gender, boolean update) {
		this.gender = gender;
		if(update)
	 ...
	 * @return			The Appearance instance.
	 */
	public Appearance setBountyHunterSkull(int skullHint, boolean update) {
	 ...
	 * @param look		Value to change look[index] to.
	 */
	public void set(int index, int look, boolean update) {
