 ...
 **/
public class DropItemLog extends Log {
    ...
    public DropItemLog(String username, String itemName, int itemId, int amount, String location, String time) {
    ...
    public SQLTable getSqlTable() {
        return SQLTable.LOGS_DROPPED_ITEMS;
    }
