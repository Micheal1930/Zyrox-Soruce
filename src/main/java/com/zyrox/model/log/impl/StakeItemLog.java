 ...
 **/
public class StakeItemLog extends Log {
    ...
    public StakeItemLog(String holder, String receiver, String itemName, int itemId, int amount, String time) {
        this.holder = holder;
    ...
    public SQLTable getSqlTable() {
        return SQLTable.LOGS_STAKED_ITEMS;
    }
